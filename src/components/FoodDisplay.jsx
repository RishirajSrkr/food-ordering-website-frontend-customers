    ...
    <div className="bg-gradient-to-b from-white to-green-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center mb-2">
          ...
          <h1 className="text-3xl font-bold text-green-600">Fresh Picks</h1>
        </div>
        
        <p className="text-gray-600 mb-8 pl-8">
          {category === "ALL" ? 
            "Explore our selection of fresh, healthy foods delivered to your doorstep" : 
            `Browsing ${category} foods - handpicked for quality and taste`}
        </p>
          ...
          {filteredFoodList && filteredFoodList.length > 0 ? (
            ...
            category !== "ALL" ? (
              <div className="col-span-3 text-center py-12 bg-white rounded-xl border border-green-100 shadow-sm">
                <Utensils className="h-16 w-16 text-green-200 mx-auto mb-4" />
                <p className="text-gray-500 text-lg mb-2">No foods found in this category.</p>
                <p className="text-gray-400 text-sm">Try another category or check back soon for new arrivals!</p>
              </div>
            ) : (
              <div className="col-span-3 text-center py-12 bg-white rounded-xl border border-green-100 shadow-sm">
                ...
                <p className="text-gray-500 text-lg mt-4">Loading delicious food options...</p>
              </div>
            )
          )}
        </div>
